...
"ShadowedUnitFrames: 각 바를 SUF 파티 프레임 옆에 고정합니다."
L["ShadowedUnitFrames"]                                                                                                           = "ShadowedUnitFrames"

-- ShadowedUnitFrames 고정
L["ShadowedUnitFrames Anchor"]                                                                                                    = "ShadowedUnitFrames 고정"
L["Bar anchor point"]                                                                                                             = "바의 고정점"
L["Which point of the SUB bar to anchor from"]                                                                                    = "SUB 바의 어느 점을 고정점으로 사용할지"
L["SUF anchor point"]                                                                                                             = "SUF 프레임의 고정점"
L["Which point of the SUF frame to attach to"]                                                                                    = "SUF 프레임의 어느 점에 부착할지"
L["Horizontal offset from the SUF anchor point (pixels)"]                                                                         = "SUF 고정점에서의 수평 오프셋 (픽셀)"
L["Vertical offset from the SUF anchor point (pixels)"]                                                                           = "SUF 고정점에서의 수직 오프셋 (픽셀)"
...
L["Color"]                                                                                                                        = "색상"
L["Colors"]                                                                                                                       = "색상"
L["Spell Rank Color"]                                                                                                             = "주문 등급 색상"
L["Reagent Count Color"]                                                                                                          = "재료 개수 색상"
