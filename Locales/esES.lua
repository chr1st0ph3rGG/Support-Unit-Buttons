...
L["SUF anchor point"]                                                                                                             = "Punto de anclaje del marco SUF"
L["Which point of the SUF frame to attach to"]                                                                                    = "Qué punto del marco SUF para la conexión"
L["Horizontal offset from the SUF anchor point (pixels)"]                                                                         =
"Desplazamiento horizontal desde el punto de anclaje SUF (píxeles)"
...
L["Color"]                                                                                                                        = "Color"
L["Colors"]                                                                                                                       = "Colores"
L["Spell Rank Color"]                                                                                                             = "Color del rango del hechizo"
L["Reagent Count Color"]                                                                                                          = "Color del recuento de reactivos"
