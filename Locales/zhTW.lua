...
"ShadowedUnitFrames：將每列錨定到 SUF 隊伍框架旁邊。"
L["ShadowedUnitFrames"]                                                                                                           = "ShadowedUnitFrames"

-- ShadowedUnitFrames 錨定
L["ShadowedUnitFrames Anchor"]                                                                                                    = "ShadowedUnitFrames 錨定"
L["Bar anchor point"]                                                                                                             = "列的錨定點"
L["Which point of the SUB bar to anchor from"]                                                                                    = "SUB 列哪個點用於錨定"
L["SUF anchor point"]                                                                                                             = "SUF 框架的錨定點"
L["Which point of the SUF frame to attach to"]                                                                                    = "SUF 框架哪個點用於附著"
L["Horizontal offset from the SUF anchor point (pixels)"]                                                                         = "從 SUF 錨定點的水平偏移（像素）"
L["Vertical offset from the SUF anchor point (pixels)"]                                                                           = "從 SUF 錨定點的垂直偏移（像素）"
...
L["Color"]                                                                                                                        = "顏色"
L["Colors"]                                                                                                                       = "顏色"
L["Spell Rank Color"]                                                                                                             = "法術等級顏色"
L["Reagent Count Color"]                                                                                                          = "材料數量顏色"
L["Normal Color"]                                                                                                                 = "常規顏色"
L["Enable"]                                                                                                                       = "啟用"
